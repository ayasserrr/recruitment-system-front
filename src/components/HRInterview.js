...
import { getHRInterview, getHRInterviewCandidates } from '../api/hrInterviewService';
...
export default function HRInterview({ applications, onBack }) {
    ...
    useEffect(() => {
        ...
        Promise.all(applications.map((app) => getHRInterview(app.id).catch(() => null)))
    ...
    useEffect(() => {
        ...
        setFetchError(null);
        Promise.all([
            getHRInterviewCandidates(selectedAppId),
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {selectedApp && loading && (
                    <div className="text-center py-16">
                        ...
                        <p className={isDarkMode ? 'text-gray-400' : 'text-base-600'}>Loading HR interview data…</p>
                    </div>
                )}
