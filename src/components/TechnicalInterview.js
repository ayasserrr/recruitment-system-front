...
export default function TechnicalInterview({ applications, onBack }) {
    ...
    const getScoreColor = (score) => {
        if (score >= 9) return isDarkMode ? 'text-green-400' : 'text-green-600';
        if (score >= 8) return isDarkMode ? 'text-blue-400' : 'text-blue-600';
        if (score >= 7) return isDarkMode ? 'text-orange-400' : 'text-orange-600';
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className={`text-4xl font-bold transition-colors ${isDarkMode ? 'text-white' : 'text-base-900'}`}>Technical Interviews</h1>
                                <p className={`transition-colors ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>Evaluate candidates' technical expertise and problem-solving skills</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <>
                        ...
                        {candidateResults.length > 0 && (
                            <div className={`rounded-2xl shadow-lg p-6 mb-8 transition-colors duration-300 ${isDarkMode ? 'bg-slate-800 shadow-slate-900' : 'bg-white shadow-base-200'}`}>
                                <h3 className={`text-xl font-bold mb-6 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-base-900'}`}>Technical Interview Results</h3>
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className={`border-b transition-colors duration-300 ${isDarkMode ? 'border-slate-600' : 'border-base-200'}`}>
                                                ...
                                                <th className={`text-left py-4 px-4 font-semibold transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>Technical</th>
                                                <th className={`text-left py-4 px-4 font-semibold transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>Problem Solving</th>
                                                <th className={`text-left py-4 px-4 font-semibold transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>System Design</th>
                                                <th className={`text-left py-4 px-4 font-semibold transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>Coding</th>
                        ...
                        <div className={`rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto transition-colors duration-300 ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}>
                            <div className="p-8">
                                <div className="flex items-center justify-between mb-6">
                                    <h2 className={`text-2xl font-bold transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-base-900'}`}>Interview Feedback</h2>
                                    <button
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className={`rounded-xl p-6 transition-colors duration-300 ${isDarkMode ? 'bg-slate-700' : 'bg-gradient-to-br from-base-50 to-accent-50'}`}>
                                            <h4 className={`font-bold mb-4 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-base-900'}`}>Technical Skills</h4>
                                            <div className="text-2xl font-bold text-accent-600 mb-2">{showFeedbackModal.technicalScore}</div>
                                            <div className={`text-sm transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-base-700'}`}>Technical knowledge and expertise</div>
                                        </div>

                                        <div className={`rounded-xl p-6 transition-colors duration-300 ${isDarkMode ? 'bg-slate-700' : 'bg-gradient-to-br from-base-50 to-accent-50'}`}>
                                            <h4 className={`font-bold mb-4 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-base-900'}`}>Problem Solving</h4>
                                            <div className="text-2xl font-bold text-accent-600 mb-2">{showFeedbackModal.problemSolving}</div>
                                            <div className={`text-sm transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-base-700'}`}>Analytical thinking and approach</div>
                                        </div>

                                        <div className={`rounded-xl p-6 transition-colors duration-300 ${isDarkMode ? 'bg-slate-700' : 'bg-gradient-to-br from-base-50 to-accent-50'}`}>
                                            <h4 className={`font-bold mb-4 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-base-900'}`}>System Design</h4>
                                            <div className="text-2xl font-bold text-accent-600 mb-2">{showFeedbackModal.systemDesign}</div>
                                            <div className={`text-sm transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-base-700'}`}>Architecture and scalability understanding</div>
                                        </div>

                                        <div className={`rounded-xl p-6 transition-colors duration-300 ${isDarkMode ? 'bg-slate-700' : 'bg-gradient-to-br from-base-50 to-accent-50'}`}>
                                            <h4 className={`font-bold mb-4 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-base-900'}`}>Coding Skills</h4>
                                            <div className="text-2xl font-bold text-accent-600 mb-2">{showFeedbackModal.coding}</div>
                                            <div className={`text-sm transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-base-700'}`}>Code quality and implementation</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`rounded-xl p-6 transition-colors duration-300 ${isDarkMode ? 'bg-slate-700' : 'bg-base-50'}`}>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-center">
                                                <span className={`transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>Technical Skills</span>
                                                <div className="flex items-center">
                                            ...
                                            <div className="flex justify-between items-center">
                                                <span className={`transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-base-600'}`}>Problem Solving</span>
                                                <div className="flex items-center">
                                                    <div className={`w-32 rounded-full h-2 mr-3 transition-colors duration-300 ${isDarkMode ? 'bg-slate-600' : 'bg-base-200'}`}>
                                                        <div
                                                            className="bg-gradient-to-r from-base-600 to-accent-600 h-2 rounded-full"
